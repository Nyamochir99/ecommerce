...
export default function ProductDetail() {
  ...
  const handleClickImage = (imageChanged: string) => {
              ...
              <div className="mt-4 grid grid-cols-4 gap-3">
                {product?.images.map((img, index) => (
                  <button
                    ...
                    key={index}
                    className={`cursor-pointer overflow-hidden rounded-xl border-2 ${image === img ? "border-zinc-900 dark:border-zinc-100" : "border-zinc-300 dark:border-zinc-500"}`}
                  >
                    <img
                      src={img}
                      alt="Thumbnail 1"
